export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	lucemon: {
		...
		types: ["Dark", "Fairy"],
		gender: "N",
		baseStats: { hp: 90, atk: 75, def: 110, spa: 90, spd: 120, spe: 115 },
	...
	siriusmon: {
		...
		types: ["Fairy", "Dragon"],
		gender: "N",
		baseStats: { hp: 95, atk: 135, def: 90, spa: 70, spd: 105, spe: 105 },
	...
	gallantmon: {
		...
		types: ["Steel"],
		gender: "N",
		baseStats: { hp: 100, atk: 130, def: 140, spa: 90, spd: 80, spe: 60 },
	...
	susanoomon: {
		...
		types: ["Fighting"],
		gender: "N",
		baseStats: { hp: 80, atk: 130, def: 75, spa: 120, spd: 75, spe: 120 },
		abilities: { 0: "Steelworker" },
		heightm: 3,
		weightkg: 340,
		color: "Brown",
