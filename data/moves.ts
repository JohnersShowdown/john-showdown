...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	courtchange: {
		...
		onHitField(target, source) {
			const sideConditions = [
				'mist', 'lightscreen', 'reflect', 'spikes', 'safeguard', 'tailwind', 'toxicspikes', 'stealthrock', 'waterpledge', 'firepledge', 'grasspledge', 'stickyweb', 'auroraveil', 'luckychant', 'gmaxsteelsurge', 'gmaxcannonade', 'gmaxvinelash', 'gmaxwildfire', 'gmaxvolcalith', 'echoshards', 'icesplinters',
			];
			let success = false;
	...
	defog: {
		...
		onHit(target, source, move) {
			...
			const removeAll = ['spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'gmaxsteelsurge', 'echoshards', 'icesplinters'];
	...
	mortalspin: {
		...
		onAfterHit(target, pokemon, move) {
			if (!move.hasSheerForce) {
				...
				const sideConditions = ['spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'gmaxsteelsurge', 'echoshards', 'icesplinters'];
	...
	prismaticlaser: {
		...
		pp: 10,
		priority: 0,
		flags: { recharge: 1, protect: 1, mirror: 1, metronome: 1, light: 1, beam: 1 },
		self: {
			volatileStatus: 'mustrecharge',
		},
		target: "normal",
	...
	solarbeam: {
		...
		pp: 10,
		priority: 0,
		flags: { charge: 1, protect: 1, mirror: 1, metronome: 1, nosleeptalk: 1, failinstruct: 1, light: 1, beam: 1 },
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	snackbreak: {
        ...
        onHit(target, source) {
              source.side.addSlotCondition(source, 'snackbreak');
        },
	},
	...
	divinesmite: {
		...
		category: "Physical",
		name: "Divine Smite",
		shortDesc: "Supereffective against Ghost types",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
		onEffectiveness(typeMod, target, type) {
	...
	anathema: {
		...
		category: "Special",
		name: "Anathema",
		shortDesc: "All active pokemon faint after 3 turns unless switched out",
		pp: 10,
		priority: 0,
	...
	devouringjaws: {
		...
		category: "Physical",
		name: "Devouring Jaws",
		shortDesc: "Nulifies the foe's Ability",
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
		target: "normal",
	...
	galesofdarkness: {
		...
		type: "Flying",
		contestType: "Beautiful",
		shortDesc: "Lowers target's Defense and Sp. Def by one stage",
		onPrepareHit: function (target, source) {
			this.attrLastMove('[still]');
    ...
    category: "Physical",
    name: "Armor Press",
	shortDesc: "Uses the user's Defense stat in damage calculations",
    pp: 10,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1 },
    overrideOffensiveStat: "def",
    ...
    basePower: 60,
    category: "Special",
	shortDesc: "Switches out the user on hit",
    name: "Backpetal",
    pp: 20,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1 },
    ...
    category: "Special",
    name: "Breeze Ball",
	shortDesc: "Inflicts more damage based on how fast the user is compared to the target. Physical if user has higher Physical ATK.",
    pp: 10,
    priority: 0,
    ...
    basePower: 0,
    category: "Status",
	shortDesc: "Removes user's Flying type. Serene Grace Effect. User's Flying moves gain 1.5x power.",
    ...
    category: "Physical",
    name: "Bygone Bash",
	shortDesc: "The user takes recoil damage around 1/3rd of the damage dealt to the target",
    pp: 5,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1, punch: 1 },
    recoil: [33, 100],
    ...
    category: "Physical",
    name: "Dig Deep",
	shortDesc: "Will always deal super-effective damage against Ground-type Pokémon.",
    pp: 20,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1 },
    onEffectiveness(typeMod, target, type) {
    ...
    category: "Physical",
    name: "Dragon Press",
	shortDesc: "Uses the user's Sp. Def stat in damage calculations",
    pp: 10,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1 },
    ...
    category: "Status",
    name: "Eerie Dance",
	shortDesc: "Raises the user's Sp. Atk and Sp. Def but lowers Speed by 1 stage each.",
    pp: 20,
    priority: 0,
    flags: { snatch: 1, dance: 1, metronome: 1 },
    boosts: {
    ...
    category: "Physical",
    name: "Fire Bomb",
	shortDesc: "Has a 100% chance to burn the target on hit.",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1, bullet: 1 },
    secondary: {
    ...
    category: "Special",
    name: "Flashbang",
	shortDesc: "Has a 10% chance to lower the target's accuracy. Spread move",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1, light: 1 },
    secondary: {
    ...
    category: "Special",
    name: "Fleur Dance",
	shortDesc: "Deals double damage if the user isn't holding a held item",
    pp: 15,
    priority: 0,
    ...
    category: "Physical",
    name: "Flying Kick",
	shortDesc: "Has a 30% chance to make the target flinch.",
    pp: 10,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, kick: 1 },
    secondary: {
	...
	shortDesc: "Restores 1/2 of the user's max HP. 1/3rd in sun.",
    pp: 5,
    priority: 0,
    ...
    basePower: 85,
    category: "Physical",
	shortDesc: "Uses the user's Defense stat in damage calculations, 30% chance to flinch.",
    name: "Guard Coat",
    pp: 10,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1 },
    ...
    category: "Status",
    name: "Hold the Line",
	shortDesc: "Sharply raises the user's Defense and Sp. Def. No Retreat Effect.",
    pp: 5,
    priority: 0,
    flags: { snatch: 1, metronome: 1 },
    volatileStatus: "noretreat",
    ...
    category: "Status",
    name: "Last Stand",
	shortDesc: "Raises the user's Speed, Sharply raises the user's Attack and Sp. Atk. No Retreat Effect.",
    pp: 5,
    priority: 0,
    flags: { snatch: 1, metronome: 1 },
    volatileStatus: "noretreat",
    ...
    category: "Special",
    name: "Let It Cook",
	shortDesc: "Lowers the user's Sp. Atk by 1 stage. Has a 10% chance to burn the target.",
    pp: 5,
    priority: 0,
    flags: { protect: 1, mirror: 1 },
    self: {
    ...
    category: "Special",
    name: "Magic Missile",
	shortDesc: "Changes type to match the user's Primary Type",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1 },
    onModifyType(move, pokemon) {
    ...
    category: "Status",
    name: "Magic Trick",
	shortDesc: "Swaps the user's Attack and Sp. Atk stats.",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, bypasssub: 1, allyanim: 1, metronome: 1 },
    onHit(target, source) {
    ...
    willCrit: true,
    target: "normal",
	shortDesc: "Will always result in a critical-hit",
    type: "Electric",
    contestType: "Cool"		
	},
	nightlight: {	
    ...
    category: "Special",
    name: "Nightlight",
	shortDesc: "Has a 10% chance to confuse the target. Spread move",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1, light: 1 },
    secondary: {
    ...
    category: "Physical",
    name: "Night Terror",
	shortDesc: "Fails unless target is asleep, Heals 3/4 of the damage dealt to the target",
    pp: 15,
    priority: 0,
    flags: { protect: 1, mirror: 1, heal: 1, metronome: 1 },
    drain: [3, 4],
    ...
    basePower: 130,
    category: "Physical",
	shortDesc: "If this move misses, the user takes 1/2 of their max HP as crash damage",
    name: "Nosedive",
    pp: 10,
    priority: 0,
    ...
    category: "Physical",
    name: "Oblique Kick",
	shortDesc: "Guaranteed to lower the target's Speed by 1 stage on hit.",
    pp: 10,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, kick: 1 },
    secondary: {
    ...
    basePower: 0,
    category: "Status",
	shortDesc: "Raises the user's Attack and Speed by 1, different effects based on coat if user is Furfrou.",
    name: "Pamper",
    pp: 15,
    priority: 0,
    flags: { snatch: 1, metronome: 1 },
    ...
    category: "Status",
    name: "Page Turn",
	shortDesc: "Raises the user's Sp. Atk and Sp. Def stats, swaps wizledger form in order Fire>Ice>Electric",
    pp: 20,
    priority: 0,
    flags: { snatch: 1, metronome: 1 },
    boosts: {
    ...
    category: "Special",
    name: "Psychic Snap",
	shortDesc: "Shatters the opponents screens",
    pp: 15,
    priority: 0,
    flags: { protect: 1, mirror: 1, sound: 1, bypasssub: 1, metronome: 1 },
    onTryHit(pokemon) {
    ...
    category: "Special",
    name: "Psyclone",
	shortDesc: "Has a 30% chance to confuse the target. Hurricane Clone",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, distance: 1, metronome: 1, wind: 1 },
    onModifyMove(move, pokemon, target) {
    ...
    name: "Psydrive",
	shortDesc: "Uses the target's Sp. Def in damage calculations.",
    pp: 10,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
    target: "normal",
    ...
    category: "Physical",
    name: "Pumpkin Bomb",
	shortDesc: "Takes 1/3 of the damage dealt as recoil damage. Has a 20% chance to burn on hit.",
    pp: 5,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1, bullet: 1 },
    recoil: [1, 3],
    ...
    category: "Status",
    name: "Relic Dance",
	shortDesc: "Raises the user's Attack, Sp. Atk, and Speed stats.",
    pp: 15,
    priority: 0,
    ...
    category: "Status",
    name: "Shiver Dance",
	shortDesc: "Raises the user's Attack and Sp. Atk. + 2 in snow or hail.",
    pp: 20,
    priority: 0,
    flags: { snatch: 1, dance: 1, metronome: 1 },
    onModifyMove(move, pokemon) {
    ...
    category: "Status",
    name: "Sleep Charm",
	shortDesc: "Puts the target to sleep. If the move succeeds, the user heals 1/4 of their max HP.",
    pp: 5,
    priority: 0,
    ...
    category: "Status",
    name: "Snow Bank",
	shortDesc: "Heals the user for 1/2 of their max HP. 2/3rd in snow or hail.",
    pp: 5,
    priority: 0,
    flags: { snatch: 1, heal: 1, metronome: 1 },
    onHit(pokemon) {
    ...
    category: "Special",
    name: "Sonic Shriek",
	shortDesc: "Ignores the target's defensive boosts and evasion boosts.",
    pp: 10,
    priority: 0,
    ...
    category: "Special",
    name: "Spirit Drain",
	shortDesc: "The user heals 1/2 the damage dealt to the target",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, heal: 1, metronome: 1 },
    drain: [1, 2],
    ...
    basePower: 25,
    category: "Special",
	shortDesc: "Hits 2-5 times in a row, if user used cosmic power increases by 1.5x power.",
    name: "Starshower",
    pp: 15,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1, light: 1 },
    ...
    category: "Physical",
    name: "Sugar Crash",
	shortDesc: "Has a 30% chance to lower the target's Speed stat.",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1 },
    secondary: {
    ...
    category: "Physical",
    name: "Terrain Blade",
	shortDesc: "Changes type to match the active Terrain. 1.5x power in terrain.",
    pp: 10,
    priority: 0,
    flags: { protect: 1, mirror: 1, metronome: 1, slicing: 1 },
    onModifyType(move, pokemon) {
    ...
    basePower: 0,
    category: "Status",
	shortDesc: "Restores 1/3th HP; Switches out the user on hit. Fails if user is Golisopede",
    name: "Turn Tail",
    pp: 5,
    priority: 0,
    flags: { snatch: 1, heal: 1, metronome: 1 },
    ...
    category: "Physical",
    name: "Valley Drop",
	shortDesc: "The user takes 1/4 of the damage dealt as recoil damage. lowers target's speed by 1",
    pp: 15,
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, throwing: 1 },
    recoil: [1, 4],
	...
	landscapeofthorns: {
		...
		basePower: 0,
		category: "Status",
		name: "Landscape of Thorns",
		target: "foeSide",
		shortDesc: "Randomly creates 2 entry hazards on opposing side",
		pp: 5,
		priority: 0,
		flags: {reflectable: 1, metronome: 1, mustpressure: 1},
		onHit(target, source, move) {
			...
			const hazards = ['spikes', 'toxicspikes', 'stealthrock', 'gmaxsteelsurge', 'icesplinters', 'echoshards'];
			for (const side of source.side.foeSidesWithConditions()) {
				const randomHazard1 = hazards[Math.floor(Math.random() * hazards.length)];
				side.addSideCondition(randomHazard1);
				const randomHazard2 = hazards[Math.floor(Math.random() * hazards.length)];
				side.addSideCondition(randomHazard2);
			}
		},
	},	
	grandcross: {
	...
	terraforce: {
		...
		category: "Physical",
		name: "Terra Force",
		shortDesc: "Supereffective on Dragon types",
		pp: 5,
		priority: 0,
	...
	lightningjoust: {
		...
		shortDesc: "Ignore's the target's stat stage changes",
		pp: 15,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, slicing: 1 },
		ignoreEvasion: true,
	...
	lacadia: {
		...
		pp: 1,
		priority: 0,
		flags: {  protect: 1, noassist: 1, failcopycat: 1, failmimic: 1, failinstruct: 1  },
		target: "normal",
		type: "Normal",
		contestType: "Tough",
	},
